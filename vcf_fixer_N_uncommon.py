#Script to loop through N_uncommon folder and correct vcf data.  To be used in zim-cos_vcf_maker.sh
...
#setting directory
directory = '/Users/philipbaldassari/Desktop/Biol_5403_Genomics/Final_project/pi_per_site/DGN_seqs/vcfs/N_uncommon/'
...
for file in os.listdir(directory):
	if file.endswith('.vcf'):
		...
		with open(file, 'r') as open_vcf:
			...
			vcf_data = vcf_data.replace('2/2', './.')
			vcf_data = vcf_data.replace('3/3', './.')
		#writing new file
