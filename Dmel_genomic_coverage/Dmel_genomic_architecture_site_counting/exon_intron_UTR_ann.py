...
file_list = ['intron_lengths.csv', 'exon_lengths.csv', 'three_prime_UTR_lengths.csv', 'five_prime_UTR_lengths.csv']

#run in parallel
def run_in_parallel():
    pool = Pool(processes=4)
    pool.map(ex_in_UTR_ann, file_list)
