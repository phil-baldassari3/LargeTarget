...
#set directories
seq_directory ='/Users/philipbaldassari/Desktop/Biol_5403_Genomics/Final_project/pi_per_site/DGN_seqs/chr2R_seq/'

converted_fas_dir ='/Users/philipbaldassari/Desktop/Biol_5403_Genomics/Final_project/pi_per_site/DGN_seqs/chr2R/'
...
for file in os.listdir(seq_directory):
    if file.endswith('.seq'):
        ...
        with open('{path}'.format(path = converted_fas_dir) + '{file}'.format(file = file), 'w') as gene:
            gene.write(sequence[8000000:8001000])
    else:
        continue   
'''
